...
#define ACCEL_X_MIN ((float) -291)
#define ACCEL_X_MAX ((float) 269)
#define ACCEL_Y_MIN ((float) -282)
#define ACCEL_Y_MAX ((float) 289)
#define ACCEL_Z_MIN ((float) -284)
#define ACCEL_Z_MAX ((float) 244)

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
//magn x,y,z (min/max) = -398.00/652.00  -265.00/773.00  -314.00/658.00
#define MAGN_X_MIN ((float) -493)
#define MAGN_X_MAX ((float) 654)
#define MAGN_Y_MIN ((float) -267)
#define MAGN_Y_MAX ((float) 785)
#define MAGN_Z_MIN ((float) -307)
#define MAGN_Z_MAX ((float) 616)

// Magnetometer (extended calibration mode)
#define CALIBRATION__MAGN_USE_EXTENDED true
const float magn_ellipsoid_center[3] = {-229.932, 108.331, -133.052};
const float magn_ellipsoid_transform[3][3] = {{0.878564, 0.00485046, -0.00207569}, {0.00485046, 0.870749, 0.0247016}, {-0.00207569, 0.0247016, 0.995268}};

#define GYRO_AVERAGE_OFFSET_X ((float) 0.36)
#define GYRO_AVERAGE_OFFSET_Y ((float) -1.32)
#define GYRO_AVERAGE_OFFSET_Z ((float) 0.54)
